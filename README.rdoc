...
Alternatively, in <tt>app/views/layouts/application.html.erb</tt>, switch the <tt>javascript_include_tag :defaults</tt> to use jquery <tt>javascript_include_tag 'jquery'</tt> instead of the default prototype helpers.
